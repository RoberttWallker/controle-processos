...
class ComprasLentes(models.Model):
    ...
    sequencial_savwin = models.IntegerField(blank=False, null=False)
    ...
    custo_site = models.DecimalField(max_digits=10, decimal_places=2, blank=False, null=False, default=0.00)
    data_liberacao_blu = models.DateField(blank=False, null=False)
    valor_pago = models.DecimalField(max_digits=10, decimal_places=2, blank=False, null=False, default=0.00)
    custo_tabela = models.DecimalField(max_digits=10, decimal_places=2, blank=False, null=False, default=0.00)
    nota_fiscal = models.IntegerField(blank=False, null=False)
    custo_nota_fiscal = models.DecimalField(max_digits=10, decimal_places=2, blank=False, null=False, default=0.00)
